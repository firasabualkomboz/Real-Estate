            ...
            <div class="container">
                ...
                <div class="alert alert-custom alert-white alert-shadow gutter-b" role="alert">
                    ...
                    <div class="alert-text">
                        <p>The Metronic Datatable support local sorting with column's data type and custom sort
                            callback.</p>For more information visit
                        <a class="font-weight-bold"
                           href="https://keenthemes.com/metronic/?page=docs&amp;section=datatable" target="_blank">Metronic
                            KTDatatable Documentation</a>.
                    </div>
                </div>
                <!--end::Notice-->
                            ...
                            <table class="datatable-bordered datatable-head-custom datatable-table" id="kt_datatable"
                                ...
                                <tr class="datatable-row" style="left: 0px;">
                                    ...
                                    <th data-field="Color" class="datatable-cell datatable-cell-sort"><span
                                            style="width: 110px;">Time Out</span></th>
                                ...
                                @foreach($appointments as $appointment)
                                    <tr data-row="0" class="datatable-row" style="left: 0px;">
                                        ...
                                        <td data-field="Car Model" aria-label="Range Rover" class="datatable-cell"><span
                                                style="width: 110px;">{{\Carbon\Carbon::createFromFormat('H:i:s',$appointment->start_at)->format('h:i')}} To {{\Carbon\Carbon::createFromFormat('H:i:s',$appointment->end_at)->format('h:i')}}
</span></td>
                                        <td data-field="Color" aria-label="Orange" class="datatable-cell"><span
                                                style="width: 110px;">{{$appointment->end_at}}</span></td>
                                        <td data-field="Deposit Paid" aria-label="$22672.60"
                                            class="datatable-cell"><span
                                                style="width: 110px;">{{$appointment->user->name}}</span></td>
                                        <td data-field="Order Date" aria-label="2016-11-28" class="datatable-cell"
                                            style="display: none;"><span style="width: 110px;">2016-11-28</span></td>
