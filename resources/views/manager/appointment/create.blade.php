                            ...
                            <form method="post" action="{{route('manager.appointments.store')}}">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <input class="form-control" type="date" name="date" value="2022-08-19"
                                               >
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label for="example-time-input" class="col-2 col-form-label">Start At </label>
                                        <div class="col-10">
                                            <input class="form-control" type="time" name="start_at" value="13:45:00"
                                                >
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="example-time-input" class="col-2 col-form-label">End At</label>
                                        <div class="col-10">
                                            <input class="form-control" type="time" name="end_at" value="13:45:00"
                                             >
                                        </div>
                                    </div>
