                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    ...
                    <div class="d-flex align-items-baseline mr-5">
                        ...
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold my-2 p-0">
                            ...
                            <li class="breadcrumb-item">
                                <a href="" class="text-muted">invoices List</a>
                            </li>
                            <li class="breadcrumb-item">
                        ...
                        >
                            ...
                            <tbody style="" class="datatable-body">
                                ...
                                <tr data-row="0" class="datatable-row" style="left: 0px;">
                                    ...
                                    <td data-field="Order ID" aria-label="0006-3629" class="datatable-cell"><span
                                        >{{$invoice->contract->apartment->name ?? $invoice->contract->estate->name}}</span></td>


                                    <td data-field="Status" data-autohide-disabled="false" aria-label="3"
                                    class="datatable-cell"><span ><span
                                            class="label font-weight-bold label-lg label-light-danger label-inline">{{$invoice->contract->type}}</span></span>
                                </td>
