            ...
            <div class="aside-secondary d-flex flex-row-fluid">
                ...
                <div class="aside-workspace scroll scroll-push my-2">
                    ...
                    <div class="tab-content">
                        <!--begin::Tab Pane-->
                        <div class="tab-pane p-3 px-lg-7 py-lg-5 fade show" id="kt_aside_tab_1">
                            <!--begin::Form-->
                                ...
                                <div id="kt_aside_menu" class="aside-menu min-h-lg-800px" data-menu-vertical="1"
                                    ...
                                    <ul class="menu-nav">
                                        ...
                                        <span class="menu-text">Estates</span>
                                                    ...
                                                    <li class="menu-item menu-item-submenu" aria-haspopup="true"
                                                        data-menu-toggle="hover">
                                                        <a href="{{route('manager.estates.index')}}"
                                                           class="menu-link menu-toggle">
                                                            <span class="menu-text">Estates List</span>
                                                            <i class="menu-arrow"></i>
                                                        </a>

                                                    </li><li class="menu-item menu-item-submenu" aria-haspopup="true"
                                                             data-menu-toggle="hover">
                                                        <a href="{{route('manager.estates.create')}}"
                                                           class="menu-link menu-toggle">
                                                            <span class="menu-text">Add Estate</span>
                                                            <i class="menu-arrow"></i>
                                                        </a>
                                        ...
                                        <span class="menu-text">Owners</span>
                                                    ...
                                                    <li class="menu-item menu-item-submenu" aria-haspopup="true"
                                                        data-menu-toggle="hover">
                                                        <a href="{{route('manager.owners.index')}}"
                                                           class="menu-link menu-toggle">
                                                            <span class="menu-text">Owners List</span>
                                                            <i class="menu-arrow"></i>
                                                        </a>

                                                    </li><li class="menu-item menu-item-submenu" aria-haspopup="true"
                                                             data-menu-toggle="hover">
                                                        <a href="{{route('manager.owners.create')}}"
                                                           class="menu-link menu-toggle">
                                                            <span class="menu-text">Add Owner</span>
                                                            <i class="menu-arrow"></i>
                                                        </a>
