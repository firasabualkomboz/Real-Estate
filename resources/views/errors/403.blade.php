...
<head><base href="../../../">
    ...
    <link href="{{asset('assets_dashboard')}}/assets/css/pages/error/error-4.css" rel="stylesheet" type="text/css" />
...
<div class="d-flex flex-column flex-root">
    <!--begin::Error-->
    <div class="error error-4 d-flex flex-row-fluid bgi-size-cover bgi-position-center" style="background-image: url({{asset('assets_dashboard')}}/assets/media/error/bg4.jpg);">
        <!--begin::Content-->
        <div class="d-flex flex-column flex-row-fluid align-items-center align-items-md-start justify-content-md-center text-center text-md-left px-10 px-md-30 py-10 py-md-0 line-height-xs">
            ...
            <p class="display-4 text-danger font-weight-boldest mt-md-0 line-height-md">you dont have any permission to this
                <br> action please login first</p>
        </div>
        <!--end::Content-->
    </div>
    <!--end::Error-->
